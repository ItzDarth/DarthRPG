...
import ru.ItzDarth.DarthRPG.worldboss.bosses.BossGenerator;
...
public class MobManager extends AbstractManagerRPG {
    ...
    private static void readMob(File f) {
        ...
        try {
            ...
            Class<? extends net.minecraft.server.v1_10_R1.Entity> entityClass = (Class<? extends Entity>) Class.forName("ru.ItzDarth.DarthCore.utils.entities." + scan.nextLine().trim());
            // level
