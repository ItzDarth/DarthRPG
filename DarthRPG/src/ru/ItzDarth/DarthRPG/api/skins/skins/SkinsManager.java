...
import ru.ItzDarth.DarthRPG.api.skins.exceptions.SkinAlreadyLoadException;
import ru.ItzDarth.DarthRPG.api.skins.exceptions.SkinNotLoadedException;
import ru.ItzDarth.DarthRPG.api.skins.nms.Skins;
...
public class SkinsManager {
    ...
    public Skin getOrLoadMojangSkin(String player) {
    	if(this.loadedMojangSkin.containsKey(player)) return this.loadedMojangSkin.get(player);
    	else {
    		SkinsUtils.loadSkins(player, null, SkinType.MOJANG);
