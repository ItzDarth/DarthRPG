 ...
 * <p>
 * You can find the project on <a href="https://github.com/MrMicky-FR/DarthParticles">GitHub</a>
 *
 * @author MrMicky
 */
public final class DarthParticle {

    private static final ParticleSender PARTICLE_SENDER;

    static {
        if (FastReflection.optionalClass("org.bukkit.Particle").isPresent()) {
