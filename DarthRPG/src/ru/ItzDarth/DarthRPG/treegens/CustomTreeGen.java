package ru.ItzDarth.DarthRPG.treegens;
...
public class CustomTreeGen extends WorldGenTreeAbstract {
    ...
    double scaleWidth = 1.5D;
    double leafDensity = 1.0D;
    int trunkSize = 1;
    int heightLimitLimit = 30;
    int leafDistanceLimit = 4;
    List<Position> leafNodes;

    private double heightMult;
    
    public CustomTreeGen(boolean paramBoolean, int heightLimitLimit, double scaleWidth, double heightMult, int trunkSize) {
        super(paramBoolean);
